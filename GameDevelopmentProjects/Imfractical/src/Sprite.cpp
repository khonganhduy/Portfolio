...
//Starts the animation for a sprite
...
//Updates the sprite and calls advance frame if the time difference between last advance is greater than
//the interval the sprite is drawn
...
// Advances the frame
// Modifies tracker values such as frame, col, and offset multilpliers to set the new values
// to get the next frame of the sprite
...
// Resets the hoffset to 0
void AnimatableSprite::resetHOff() {
	hOffsetMultiplier = 0;
}

// Resets all the tracker values of the sprite
...
// Set all positional, offset, and time values for the sprite
// These are used to get the correct position of a desired sprite in a sprite sheet
